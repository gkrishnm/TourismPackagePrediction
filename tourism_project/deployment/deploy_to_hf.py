...
def deploy_to_huggingface_space():
    ...
    try:
        api = HfApi()
        space_id = "gkrishnm/tourism_project"
        ...
        print(f"Uploading files to space: gkrishnm/Tourism-Package-Prediction")
        ...
        print(f"App URL: https://huggingface.co/spaces/Tourism-Package-Prediction")
        return True
